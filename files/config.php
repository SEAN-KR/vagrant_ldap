...
//bobot
$servers->setValue('server','name','Odapper LDAP Server');
...
//bobot
//$servers->setValue('server','base',array('dc=home,dc=net'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
//bobot
$servers->setValue('login','bind_id','cn=admin,dc=home,dc=net');
